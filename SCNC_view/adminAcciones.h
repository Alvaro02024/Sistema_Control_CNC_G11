...
namespace SCNCview {
	...
	/// <summary>
	/// Summary for adminAcciones
	/// </summary>
	public ref class adminAcciones : public System::Windows::Forms::Form
	{
	public:
		adminAcciones(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox2->Size = System::Drawing::Size(328, 261);
			...
			this->button4->Text = L"Cerrar sesión";
